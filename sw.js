const CACHE_NAME = 'yt-dash-ultimate-v3';
...
self.addEventListener('fetch', (event) => {
  ...
  // Always go to network for API calls (YouTube, Gemini, Google Suggest)
  if (
  ...
  // Cache-first for everything else (static assets, fonts, chart.js)
  event.respondWith(
